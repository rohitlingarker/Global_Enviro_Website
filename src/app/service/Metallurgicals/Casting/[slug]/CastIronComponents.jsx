  ...
  return (
    <div className="bg-white text-gray-800 leading-relaxed">
      ...
      <section className="max-w-6xl mx-auto px-6 py-10">
        ...
        <p>
          Cast Iron Components are robust industrial parts manufactured
          using high-quality cast iron to provide excellent strength, wear
          resistance, vibration damping, and durability. Widely used across
          heavy engineering and machinery applications, these components
          offer reliable performance, dimensional stability, and
          cost-effective operation in demanding industrial environments.
        </p>
      </section>
