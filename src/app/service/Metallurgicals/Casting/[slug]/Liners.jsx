    ...
    <div className="bg-white text-gray-800 leading-relaxed">
      ...
      <section className="max-w-6xl mx-auto px-6 py-10">
        ...
        <p>
          ...
          during material handling and processing operations. Manufactured
          from high-strength and wear-resistant materials, liners enhance
          equipment durability, reduce maintenance costs, and improve
          operational efficiency in demanding industrial environments.
        </p>
      </section>
