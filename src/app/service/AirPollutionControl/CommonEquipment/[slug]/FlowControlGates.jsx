    ...
    <div className="bg-white text-gray-800 leading-relaxed">
      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-2 gap-3 items-center px-6 py-4">
        <div>
          ...
          <p>
            Flow Control Gate is a shut-off and regulating device installed
            below silos, hoppers, conveyors, and chutes to start, stop, or
            modulate the flow of dry bulk solids. Available as slide gate,
            knife gate, or diverter type, it provides positive shut-off,
            variable discharge, and material routing with dust-tight
            sealing.
          </p>
